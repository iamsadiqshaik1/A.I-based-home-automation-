...
if __name__=="__main__":
    ...
    while True:
        ...
        elif 'light red on' in query:
            light1()
        elif 'light green on' in query:
            light2()
        elif 'light blue on' in query:
            light3()
        elif 'light red off' in query:
            light1off()
        elif 'light green off' in query:
            light2off()
        elif 'light blue off' in query:
            light3off()
        elif 'motor on' in query:
            motor()
        elif 'motor off' in query:
            motoroff()
